...
export const register = async (
  ...
  (
    await axiosClient.post(ENDPOINTS.client.auth.register, input, {
...
export const forgotPassword = async (
  ...
  (
    await axiosClient.post(ENDPOINTS.client.auth.forgotPassword, input, {
      headers: { "Idempotency-Key": idempotencyKey },
    })
  ).data;
...
export const resetPassword = async (
  ...
  (
    await axiosClient.patch(ENDPOINTS.client.auth.resetPassword, input, {
      headers: { "Idempotency-Key": idempotencyKey },
    })
  ).data;
